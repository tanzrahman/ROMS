...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    $.extend(Selectize.prototype, {
        ...
        setup: function () {
            ...
            $dropdown = $('<div>').addClass(settings.dropdownClass).addClass(inputMode + ' selectize-dropdown').attr('id',settings.inputClass).hide().appendTo($dropdown_parent);
            $dropdown_content = $('<div>').addClass(settings.dropdownContentClass + ' selectize-dropdown-content').attr({'tabindex': '-1','id':$input.attr('id')+'_options'}).appendTo($dropdown);
        ...
        onOptionHover: function (e) {
            if(e.delegateTarget.id!='no_fetch'){
                if(e.delegateTarget.id == 'fetch_task_title'){
                    fetch_task_details(e.currentTarget.dataset.value);
                }
                if(e.delegateTarget.id == 'auto_fetch'){
                    fetch_assigned_task_list(e.currentTarget.dataset.value);
                }
